...
import type { CreateBlogPostDto } from '@/types/post.types';
    ...
    <Layout>
      <div className="mb-6 sm:mb-8 flex flex-col gap-3 sm:gap-4">
        <div>
          ...
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-1">Write and publish a new article</p>
        </div>
